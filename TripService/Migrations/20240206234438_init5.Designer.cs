...
namespace KayakTracker.Migrations
{
    ...
    [Migration("20240206234438_init5")]
    partial class init5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KayakTracker.Domain.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvgSpeed = 6.0,
                            DistanceMiles = 10.0,
                            EndDate = new DateTime(2024, 2, 6, 23, 44, 37, 925, DateTimeKind.Utc).AddTicks(4651),
                            Notes = "notes",
                            OwnerId = "1",
                            RiverId = 1,
                            StartCoordinates = "37.362,-91.543",
                            StartDate = new DateTime(2024, 2, 6, 23, 44, 37, 925, DateTimeKind.Utc).AddTicks(4643),
                            StartName = "boat ramp",
                            State = 0,
                            TimeMinutes = 600.0
                        });

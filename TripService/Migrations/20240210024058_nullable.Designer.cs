...
namespace KayakTracker.Migrations
{
    ...
    [Migration("20240210024058_nullable")]
            ...
            modelBuilder.Entity("KayakTracker.Domain.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvgSpeed = 6.0,
                            DistanceMiles = 10.0,
                            EndDate = new DateTime(2024, 2, 10, 2, 40, 58, 537, DateTimeKind.Utc).AddTicks(6374),
                            Notes = "notes",
                            OwnerId = "1",
                            RiverId = 1,
                            StartCoordinates = "37.362,-91.543",
                            StartDate = new DateTime(2024, 2, 10, 2, 40, 58, 537, DateTimeKind.Utc).AddTicks(6363),
                            StartName = "boat ramp",
                            State = 0,
                            TimeMinutes = 600.0
                        });

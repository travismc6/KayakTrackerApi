...
namespace KayakTracker.Migrations
{
    ...
    [Migration("20240206234221_init4")]
    partial class init4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KayakTracker.Domain.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvgSpeed = 6.0,
                            DistanceMiles = 10.0,
                            EndDate = new DateTime(2024, 2, 6, 23, 42, 20, 959, DateTimeKind.Utc).AddTicks(1319),
                            Notes = "notes",
                            OwnerId = "1",
                            RiverId = 1,
                            StartCoordinates = "37.362,-91.543",
                            StartDate = new DateTime(2024, 2, 6, 23, 42, 20, 959, DateTimeKind.Utc).AddTicks(1312),
                            StartName = "boat ramp",
                            State = 0,
                            TimeMinutes = 600.0
                        });

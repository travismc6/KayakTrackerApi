...
namespace KayakTracker.Migrations
{
    ...
    [Migration("20240207002104_init6")]
    partial class init6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KayakTracker.Domain.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvgSpeed = 6.0,
                            DistanceMiles = 10.0,
                            EndDate = new DateTime(2024, 2, 7, 0, 21, 4, 193, DateTimeKind.Utc).AddTicks(9345),
                            Notes = "notes",
                            OwnerId = "1",
                            RiverId = 1,
                            StartCoordinates = "37.362,-91.543",
                            StartDate = new DateTime(2024, 2, 7, 0, 21, 4, 193, DateTimeKind.Utc).AddTicks(9337),
                            StartName = "boat ramp",
                            State = 0,
                            TimeMinutes = 600.0
                        });
